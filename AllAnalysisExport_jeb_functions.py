...
def NI_build_ni_csv_path(base_path, set_type, sample_type, folder, canon_reg, original_sample_type=None):
    ...
    Supports:
        JEB line scans
        JEB upper/lower dermis grids
        AP1 line scans
        wounding line scans

    Expected JEB structure:
        base_path/
            WT/
                line scan/
                lower dermis/
    ...
    if st_lower == "jeb":
        subfolder_aliases = {
            "lower dermis": ["lower dermis", "lowerdermis", "lower_dermis"],
            "upper dermis": ["upper dermis", "upperdermis", "upper_dermis"],
            "linescan": ["line scan", "linescan", "line_scan"],
        }

        subfolders = subfolder_aliases[reg_key]
        ...
        subtype_folder_aliases = {
            ...
            "wt_d7": ["WT_D7", "wt_d7", "WT D7", "wt d7"],
            "ko_d7": ["KO_D7", "ko_d7", "KO D7", "ko d7"],

            "wt_d10": ["WT_D10", "wt_d10", "WT D10", "wt d10"],
            "ko_d10": ["KO_D10", "ko_d10", "KO D10", "ko d10"],

            "wt_d14": ["WT_D14", "wt_d14", "WT D14", "wt d14"],
            "ko_d14": ["KO_D14", "ko_d14", "KO D14", "ko d14"],

            "wt_d19": ["WT_D19", "wt_d19", "WT D19", "wt d19"],
            "ko_d19": ["KO_D19", "ko_d19", "KO D19", "ko d19"],

            "wt_vh": ["WT_VH", "wt_vh", "WT VH", "wt vh"],
            "ko_vh": ["KO_VH", "ko_vh", "KO VH", "ko vh"],

            "wt_rad": ["WT_RAD", "wt_rad", "WT RAD", "wt rad"],
            "ko_rad": ["KO_RAD", "ko_rad", "KO RAD", "ko rad"],

            "wt_vhneck": ["WT_VHNECK", "wt_vhneck", "WT_VH_NECK", "WT VH NECK", "wt vh neck"],
            "ko_vhneck": ["KO_VHNECK", "ko_vhneck", "KO_VH_NECK", "KO VH NECK", "ko vh neck"],

            "wt_radneck": ["WT_RADNECK", "wt_radneck", "WT_RAD_NECK", "WT RAD NECK", "wt rad neck"],
            "ko_radneck": ["KO_RADNECK", "ko_radneck", "KO_RAD_NECK", "KO RAD NECK", "ko rad neck"],
        }
        ...
        filename_options = [
            ...
            f"OutputExcel_{folder}_line scan.csv",
            f"OutputExcel_{folder}_{reg_key}.csv",
    ...
    if st_lower == "ap1":
        ...
        subtype_folder_aliases = {
            "ts": ["TS", "ts", "T5224", "t5224"],
            "vh": ["VH", "vh", "Vehicle", "vehicle"],
            "ac": ["AC", "ac", "Acetone", "acetone"],
            "cl": ["CL", "cl", "Clomipramine", "clomipramine"],
        }
    ...
    if st_lower == "wounding":
        folder_path = NI_find_existing_dir(
            ...
            os.path.join(base_path, sample_type),
            os.path.join(base_path, sample_type.upper()),
            os.path.join(base_path, sample_type.lower()),
        )
