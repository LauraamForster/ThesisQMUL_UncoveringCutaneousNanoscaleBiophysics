...
import AllAnalysisExport_jeb_functions as FN
import os
...
ManifestDir = Path("/Users/lauraforster/Documents/Uni/3 - PhD/Raman/Papers and Presentations/Samples/Raman Manifest jeb.xlsx")
Save_folder = Path("/Users/lauraforster/Documents/Uni/3 - PhD/Raman/Papers and Presentations/Samples/")

# NANOINDENTATION
NI_base_path = f"/Volumes/LauraDrive/Nanoindentation/NI_Data/Output/CSV/JEB"
NI_manifest_path = f"/Users/lauraforster/Documents/Uni/3 - PhD/Nanoindentation/Data Analysis/Analysis2025/Manifests/JEBManifest.csv"

# SAXS
ROI_XLSX = Path("/Volumes/LauraDrive/SAXS/Presentations and notes/Manifests/ROI_points_simplified.xlsx")
MANIFEST_XLSX = Path("/Volumes/LauraDrive/SAXS/Presentations and notes/Manifests/SAXS Manifest_jeb.xlsx")
...
Subtypes = ["wt", "ko", "wt_d7", "ko_d7", "wt_d10","ko_d10",
            "wt_d14","ko_d14","wt_d19","ko_d19","wt_vh","ko_vh",
            "wt_rad","ko_rad","wt_vhneck","ko_vhneck","wt_radneck","ko_radneck"]
...
# NANOINDENTATION
NI_set_type = "JEB"
NI_regions = ["line scan", "lower dermis", "upper dermis"]
...
NI_order = (
    NI_groups["JEB group 1"]
    + NI_groups["JEB group 2"]
    + NI_groups["JEB group 3"]
)
...
EXPORT_ROOT = Path("/Volumes/LauraDrive/Multitech_Export_jeb")
