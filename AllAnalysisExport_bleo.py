...
import AllAnalysisExport_bleo_functions as FN
import os
...
ManifestDir = Path("/Users/lauraforster/Documents/Uni/3 - PhD/Raman/Papers and Presentations/Samples/Raman Manifest Bleo.xlsx")
Save_folder = Path("/Users/lauraforster/Documents/Uni/3 - PhD/Raman/Papers and Presentations/Samples/")

# NANOINDENTATION
NI_base_path = f"/Volumes/LauraDrive/Nanoindentation/NI_Data/Output/CSV/bleomycin"
NI_manifest_path = f"/Users/lauraforster/Documents/Uni/3 - PhD/Nanoindentation/Data Analysis/Analysis2025/Manifests/BleomycinManifest.csv"

# SAXS
ROI_XLSX = Path("/Volumes/LauraDrive/SAXS/Presentations and notes/Manifests/ROI_points_simplified.xlsx")
MANIFEST_XLSX = Path("/Volumes/LauraDrive/SAXS/Presentations and notes/Manifests/SAXS Manifest_bleo.xlsx")
...
Subtypes = ["pbs", "2w", "4w", "bm", "bmmet", "pbsmet", "4wmet", "pbsokn", "4wokn"]
...
REPORT_GROUPS = {
    "Bleo group 1": ["pbs", "2w", "4w"],
    "Bleo group 2": ["pbsmet", "bmmet"],
    "Bleo group 3": ["pbsokn", "4wokn"],
}
# =============================================================================
# PROCESSING RAMAN
# =============================================================================
...
EXPORT_ROOT = Path("/Volumes/LauraDrive/Multitech_Export_bleo")
